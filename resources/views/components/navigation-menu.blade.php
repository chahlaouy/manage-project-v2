<ul class="">      
        ...
        <x-nav-link :active="request()->routeIs('dashboard')" class="mb-6" href="{{route('dashboard')}}">
            <span class="block w-5 text">
                <svg viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <g id="Page-1" stroke="none" stroke-width="1" class="fill-current {{request()->routeIs('dashboard') ? 'text-indigo-500' : 'text-gray-400'}}" fill-rule="evenodd">
                        <g id="icon-shape">
    ...
    <li>
        <x-nav-link :active="request()->routeIs('home')" class="mb-6">
            <span class="block w-5">
                <svg viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <g id="Page-1" stroke="none" stroke-width="1" class="fill-current {{request()->routeIs('home') ? 'text-indigo-500' : 'text-gray-400'}}" fill-rule="evenodd">
                        <g id="icon-shape">
    ...
    <li>
        <x-nav-link :active="request()->routeIs('home')">
            <span class="block w-5">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"  class="fill-current {{request()->routeIs('home') ? 'text-indigo-500' : 'text-gray-400'}}" ><path d="M4.16 4.16l1.42 1.42A6.99 6.99 0 0 0 10 18a7 7 0 0 0 4.42-12.42l1.42-1.42a9 9 0 1 1-11.69 0zM9 0h2v8H9V0z"></path></svg>
            </span>
        </x-nav-link>
    </li>
