{{-- Complete button --}}
<div class="rounded flex items-center p-2 mr-3 {{ $task->completed ? 'text-green-700 bg-green-300' : 'text-gray-500 bg-gray-200'}}">
    <span class="block w-5 mr-1">
        <svg viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            <g id="Page-1" stroke="none" stroke-width="1" class="fill-current {{ $task->completed ? 'text-green-700' : 'text-gray-400'}} "  fill-rule="evenodd">
                <g id="icon-shape">
