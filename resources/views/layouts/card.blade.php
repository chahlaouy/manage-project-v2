<div class="bg-white py-4 h-64 relative shadow-md rounded">
    ...
    <a href="{{$project->path()}}" class="block text-xl font-normal px-8 border-l-4 border-purple-600 py-3 mb-6"> {{$project->title}} </a>
